...
<head>
	...
	include_once 'custom-css-js.php';

	/* Подключаем Микроразметку Open Graph*/
...
<div id="wrapper">
   <div id="middle">
			...
			<?php
				...
				include_once $document_root.'/assets/inc/breadcrumbs-2.php';
			?>
			</header>
       <div id="content" <?php include_once $document_root.'/assets/inc/schema-softwareapplication.php'; ?>
          <div id="colLeft">							
			<?php
			...
			?>
				...
				<?php
				/* Подключаем кастомный H1 */
				include_once 'custom-h1.php';
				?>
				</header>
				...
				//leaderboard.php - ТОП игроков, файл который вызывается при загрузке страницы
